...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Sate</h1>
    </div>
    <div class="container">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Update Country') }}
                        <a class="float-right" href="{{ route('states.index') }}">Back</a>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('states.update', $state->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="country_id" @error('country_id') is-invalid
                                        @enderror" name="country_id" value="{{ old('country_id') }}" required
